...
KIND_CLUSTER ?= cloudfront-tenant-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name cloudfront-tenant-operator-builder
	$(CONTAINER_TOOL) buildx use cloudfront-tenant-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm cloudfront-tenant-operator-builder
	rm Dockerfile.cross
