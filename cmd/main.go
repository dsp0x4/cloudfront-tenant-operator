...
import (
	...
	"github.com/paolo-desantis/cloudfront-tenant-operator/internal/controller"
	_ "github.com/paolo-desantis/cloudfront-tenant-operator/internal/metrics" // Register Prometheus metrics
...
func init() {
	...
	utilruntime.Must(cloudfrontv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "dd008127.cloudfront-tenant-operator.io",
	...
	if awsRegion != "" {
		awsConfigOpts = append(awsConfigOpts, awsconfig.WithRegion(awsRegion))
	}
